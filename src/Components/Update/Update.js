...
const Update = () => {
  ...
  const handleFruitsUpdate = (e) => {
    e.preventDefault();
    const quantity =
      parseInt(e.target.quantity.value) + parseInt(Items.quantity);
    ...
    <div>
      <div className="row">
          ...
          <Card className="update-container">
            ...
            <Card.Body>
              ...
              <div className="line">
                ...
                <p>
                  <span className="fw-bold">Color:</span> {Items.Color}
                </p>
                <p>
                ...
                <p>
                  <span className="fw-bold">Gender:</span> {Items.gender}
                </p>
                <p>
                  <span className="fw-bold">Email: </span> {Items.email}
                </p>
                <p>
                  <span className="fw-bold">Phone: </span> {Items.phone}
                </p>
                <p>
                  <span className="fw-bold">Address: </span> {Items.address}
                </p>
                <p>
            ...
            {Items.quantity === 0 ? (
              <button className="btn-danger border-0 text-white p-2">
                sold out
              </button>
            ) : (
              <button
                onClick={() => handleDeliver(inventoryId)}
                className="border-0 p-2 btn-primary"
              >
                Delivered
              </button>
            )}
        ...
        <div className="col-lg-6 update mt-3">
          ...
          <form onSubmit={handleFruitsUpdate} className="d-flex flex-column">
            <label className="fw-bold" htmlFor="quantity">
              Stock*
            </label>
      ...
      <div className="mb-5 d-flex justify-content-center align-items-center">
        <CustomLink to="/inventory">
          <button className="login-btn">Inventory Page</button>
        </CustomLink>
      </div>
    </div>
  );
